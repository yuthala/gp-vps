    ...
    <footer className="w-full flex justify-center font-bold bg-(--light-green)">
      <div className="max-w-7xl px-4 sm:px-6 lg:px-8 py-6 md:py-10">
        <div className="flex flex-col items-center gap-3 md:gap-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 py-3 text-foreground">
            <div>
          ...
          {/* Section 5 - 2 columns with align-center */}
					<div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-4 pt-3 border-t border-white/20 items-center">
						<div>
