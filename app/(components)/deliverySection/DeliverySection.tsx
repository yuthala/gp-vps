...
После получения вашего заказа мы начнем его собирать. Сбор заказа занимает 1-3 рабочих дня.</p>
					...
					<p>Товары надлежащего качества, продаваемые в нашем магазине, не подлежат обмену и возврату (согласно постановлению Правительства РФ №55). Мы тщательно следим за качеством отгружаемой продукции, однако в некоторых случаях возможна порча посевного материала во время перевозки. Если вы получили товар ненадлежащего качества, свяжитесь, пожалуйста с нами - мы осущестим возврат денежных средств или обмен товара (по договоренности).</p>
				</div>
			</div>
		</section>
	)
