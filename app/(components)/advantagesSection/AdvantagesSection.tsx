  ...
  return (
    <section className="flex justify-center w-full">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="advantages-heading pb-8 lg:pb-12">Здесь вы можете приоберсти оригинальную продукцию <span className="text-3xl lg:text-4xl lowercase font-bold text-(--secondary)">green pato</span></h2>

        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 text-foreground font-light text-lg leading-[1.3]">
					{cards.map((card) => {
						return (
